...
class CompanySettingsConrtoller extends Controller
{
    ...
    {
        return response(view('backend.element.company_settings.edit'));
    }
            ...
            try {
                $companySettings = CompanyModel::updateOrCreate(
                    ...
                    [
                        ...
                        'shipping_charge_inside_dhaka'          =>$request->shipping_charge_inside_dhaka,
                        'shipping_charge_outside_dhaka'         =>$request->shipping_charge_outside_dhaka,
                        'shipping_charge_near_dhaka'            =>$request->shipping_charge_near_dhaka,

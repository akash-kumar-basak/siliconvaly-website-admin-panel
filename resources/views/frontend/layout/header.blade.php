...
<div id="offcanvas-cart" class="offcanvas offcanvas-cart">
    <div class="inner">
        ...
        <div class="foot">
            ...
            <div class="buttons">
                <a href="/product_carts" class="btn btn-dark btn-hover-primary mb-30px">view cart</a>
                <a href="/product_checkouts" class="btn btn-outline-dark current-btn">checkout</a>
            </div>

        ...
        <div class="container">
            <div class="header-nav-wrapper d-md-flex d-sm-flex d-xl-flex d-lg-flex justify-content-between">
                <div class="header-static-nav">
                    <p>Welcome you to Siliconvaly.com!</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 d-flex">
                    ...
                    <div class="logo">
                        <a href="index.html"><img class="img-responsive" src="{{asset($CompanyInformation->company_logo)}}" /></a>
                    </div>
                </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col">
                <div class="header-logo">
                    <a href="index.html"><img class="img-responsive" src="{{asset('images/logo/logo.jpg')}}" alt="logo.jpg" /></a>
                </div>
            </div>
            <!-- Header Logo End -->

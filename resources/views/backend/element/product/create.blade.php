                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                <div>
                                                                    ...
                                                                    <textarea class="form-control summernote" placeholder="Enter Short Description" name="shortDescription" rows="2"></textarea>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="mb-3">
                                                                <div>
                                                                    ...
                                                                    <textarea class="form-control summernote" placeholder="Enter Long Description" name="longDescription" rows="6"></textarea>
